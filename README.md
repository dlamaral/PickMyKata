...
Your privacy is important. This privacy policy explains how Pick My Kata handles your data.

1. Data Collection and Storage

Pick My Kata does not collect, transmit, or store any personal data on external servers.

Local Storage: All app data—including your practice logs, streaks, settings, and preferences—is stored locally on your device using Apple's SwiftData framework.

No Accounts: You do not need to create an account or login to use the app.

No Tracking: We do not track your location, usage habits, or personal identity. We do not use third-party analytics services.

2. User Controls

Reset Data: You have full control over your data. You can wipe all progress and logs instantly via the "Reset Progress" button in the Settings menu.

Deleting the App: Uninstalling the application will permanently delete all local data associated with it.
